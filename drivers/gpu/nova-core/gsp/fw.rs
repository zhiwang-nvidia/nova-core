...
pub(crate) const GSP_FW_HEAP_SIZE_VGPU_DEFAULT: u64 = r570::GSP_FW_HEAP_SIZE_VGPU_DEFAULT as u64;
pub(crate) const GSP_FW_HEAP_SIZE_VGPU_48VMS: u64 = r570::GSP_FW_HEAP_SIZE_VGPU_48VMS as u64;
pub(crate) const MAX_PARTITIONS_WITH_GFID: u8 = r570::MAX_PARTITIONS_WITH_GFID;
pub(crate) const MAX_PARTITIONS_WITH_GFID_32VM: u8 = r570::MAX_PARTITIONS_WITH_GFID_32VM;
...
impl fmt::Display for MsgFunction {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            ...
            MsgFunction::GspLoadExecGenericBootloader => write!(f, "LOAD_EXEC_GENERIC_BOOTLOADER"),
            MsgFunction::GspLoadExecHsBinary => write!(f, "LOAD_EXEC_HS_BINARY"),
...
impl GspVfInfo {
    ...
    pub(crate) fn new(pdev: &pci::Device<device::Bound>) -> Result<GspVfInfo> {
        ...
        let bar1_raw = kernel::io_read!(sriov, .vf_bar[1]?);
        let bar3_raw = kernel::io_read!(sriov, .vf_bar[3]?);
        ...
        Ok(GspVfInfo(r570::GSP_VF_INFO {
            ...
            b64bitBar1: u8::from((bar1_raw & 0x6) == 0x4),
            FirstVFBar1Address: sriov.read_vf_bar64(1)?,
            b64bitBar2: u8::from((bar3_raw & 0x6) == 0x4),
            FirstVFBar2Address: sriov.read_vf_bar64(3)?,
            ..Zeroable::zeroed()
        }))
    }
}
