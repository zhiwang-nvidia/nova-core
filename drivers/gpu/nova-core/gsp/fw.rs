...
pub(crate) mod vgpu_bindings {
    pub(crate) use super::r000_00::{
        GMCAPI_COMMANDS_GMCAPI_CMD_ADD_VGPU_TYPE,
        GMCAPI_COMMANDS_GMCAPI_CMD_ASSIGN_VGPU_TYPE,
        GMCAPI_COMMANDS_GMCAPI_CMD_BOOTLOAD_GSP_VGPU_PLUGIN_TASK,
        GMCAPI_COMMANDS_GMCAPI_CMD_CLEANUP_GSP_VGPU_PLUGIN_RESOURCES,
        GMCAPI_COMMANDS_GMCAPI_CMD_DEASSIGN_VGPU_TYPE,
        GMCAPI_COMMANDS_GMCAPI_CMD_QUERY_ASSIGNED_VF_VGPU_TYPE,
        GMCAPI_COMMANDS_GMCAPI_CMD_QUERY_CREATABLE_VGPU_TYPES,
        GMCAPI_COMMANDS_GMCAPI_CMD_QUERY_SUPPORTED_VGPU_TYPES,
