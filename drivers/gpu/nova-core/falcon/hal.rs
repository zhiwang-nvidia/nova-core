...
mod tests {
    ...
    /// The RISC-V routing offsets change at GA102, so GA100 still uses the Turing ones. GA100
    /// falls on the other side of the retrigger gate above, which is why the two are separate.
    #[test]
