...
/// Fixed GSP SWGEN0 notification vector, which GSP-RM assigns on every supported chip.
...
///
/// Declaration order is the teardown order, and the order is required. See "Enabling the GSP
/// event" in `Documentation/gpu/nova/core/interrupts.rst`.
#[pin_data]
