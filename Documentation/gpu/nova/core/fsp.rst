...
===============================================
FSP (Falcon Security Processor) and Secure Boot
===============================================
...
What is FSP?
============
The Falcon Security Processor (FSP) is the GPU's Internal Root of Trust
...
In the nova-core driver, these headers are modeled using ``bitfield!`` types
(``MctpHeader`` and ``NvdmHeader``) and encapsulated in the ``FspMessageHeader``
structure with a ``new()`` constructor that builds the standard header for a
given NVDM type.
...
References
==========
Internal NVIDIA Confluence pages used as source material:

- `FSP Chain of Trust <https://confluence.nvidia.com/display/HOPSEC/FSP+Chain+of+Trust>`_
- `NVIDIA H100 GPU Chain of Trust boot architecture <https://confluence.nvidia.com/display/RMChipsSecurity/NVIDIA+H100+GPU+Chain+of+Trust+boot+architecture>`_
- `FSP Firmware Architecture <https://confluence.nvidia.com/display/HOPSEC/FSP+Firmware+Architecture>`_
- `FSP IPC-RPC Design <https://confluence.nvidia.com/display/GFWGH100/FSP+IPC-RPC+Design>`_
  (NVDM over MCTP binding, message format)
- `NVDM Message Type allocation <https://confluence.nvidia.com/display/GFWGH100/NVDM+Message+Type+allocation>`_
  (COT/PRC payload wire format, FSP command response)
- `GH100 FSP IAS <https://confluence.nvidia.com/display/FalconSecurityIPUserSpace/GH100+FSP+IAS>`_
- `Product Reconfiguration <https://confluence.nvidia.com/display/GFWGH100/Product+Reconfiguration>`_
